  ...
  return (
    <div className="relative min-h-[calc(100vh-6rem)] overflow-hidden bg-bg-warm">
      ...
      <motion.div 
        ...
        className="max-w-[1280px] w-full mx-auto px-4 sm:px-6 py-12 min-h-[calc(100vh-6rem)] flex flex-col relative z-10 translate-x-6"
      >
      ...
      <div className="fixed bottom-2 left-0 right-0 pointer-events-none z-50">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 relative translate-x-6">
          <button
            onClick={scrollToTop}
            className="absolute bottom-0 left-4 sm:left-6 -ml-4 sm:-ml-16 pointer-events-auto w-12 h-12 bg-white rounded-full shadow-lg border border-gray-200 flex items-center justify-center text-gray-400 hover:text-brand-orange hover:border-brand-orange/30 transition-colors"
            title="回到顶部"
          >
